      ...
      <div id="minisb">
        <div class="d-flex flex-column flex-shrink-0  col divsb" style="width: 4.5rem;">
          ...
          <ul class="nav nav-pills nav-flush flex-column mb-auto text-center miul">
            ...
            <li>
              <a href="productos.php" class="nav-link py-3 border-bottom rounded-0" title="Products" data-bs-toggle="tooltip" data-bs-placement="right">
            ...
            <li>
              ...
              <a href="
              <?php
                        $rolUsuario = $_SESSION['idRol'];


                        if ($rolUsuario == "1") {
                          $enlace = "formularioUsuario.php";
                          echo $enlace;
                        } else {
                          echo $enlace = "#";
                        }
                        ?>
                        " class="nav-link py-3 border-bottom rounded-0" title="Customers" data-bs-toggle="tooltip" data-bs-placement="right">
        ...
        <div class="pa">
            ...
            <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner imgc">
                <div class="carousel-item active" data-bs-interval="10000">
                  <img src="imagenes/Captura de pantalla 2023-03-21 073922.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="imagenes/Captura de pantalla 2023-03-21 074046.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item " data-bs-interval="10000">
                  <img src="imagenes/Captura de pantalla 2023-03-21 074110.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item " data-bs-interval="10000">
                  <img src="imagenes/Captura de pantalla 2023-05-18 082355.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item active" data-bs-interval="10000">
                  <img src="imagenes/Captura de pantalla 2023-05-16 174931.png" class="d-block w-100" alt="...">
                </div>
          ...
          <div id="contP">
            <div class="pro">
              <img class="Products" src="imagenes/Captura de pantalla 2023-03-21 080714.png" alt="">
              Computadores
            </div>
            <div class="pro">
              <img class="Products" src="imagenes/Captura de pantalla 2023-03-21 080757.png" alt="">
              Electrodomésticos
            </div>
            <div class="pro">
              <img class="Products" src="imagenes/Captura de pantalla 2023-03-21 080843.png" alt="">
              Vegetales
            </div>
            <div class="pro">
              <img class="Products" src="imagenes/Captura de pantalla 2023-03-21 081242.png" alt="">
              Papeleria
            </div>
            <div class="pro">
              <img class="Products" src="imagenes/Captura de pantalla 2023-03-21 081915.png" alt="">
              Licoreria
            </div>
            <div class="pro">
              <img class="Products" src="imagenes/Captura de pantalla 2023-03-21 102123.png" alt="">
              Jugueteria
            </div>
            <div class="pro">
              <img class="Products" src="imagenes/Captura de pantalla 2023-03-21 102634.png" alt="">
              Hogar y decoración
            </div>
