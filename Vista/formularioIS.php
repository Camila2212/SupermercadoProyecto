  ...
  <div class="midiv2">
    ...
    <div id="miform3">
      <div id="miform2">
        ...
        <form class="miform" action="../Controlador/controladorIS.php" method="post">

          <h2 class="IS">INICIAR SESION</h2>
          <hr class="linea">
          <div class="mI">
          <?php  echo '<i class="bi bi-exclamation-octagon"></i> ' . $mensaje . ''; ?>
          </div>
          ...
          <a href="formularioModal.php" style="text-decoration: none;">Olvidaste tu contraseña?</a>

          <hr>
          <button type="submit" class="mibtn2 btn btn-primary" name="fEnviar" value="c">Iniciar Sesion</button>
          <a class="a" href="formularioAD.php">Crear Cuenta</a>
