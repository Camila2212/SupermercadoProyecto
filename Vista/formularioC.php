...
<body>
  ...
  <div id="mediosb">
    <div id="minisb">
      ...
      <div class="cont">
        ...
        <div class="medioC">
          <header>
            <h1 class="t">Formulario Clientes</h1>
            ...
            <table class="mit" border="1">
              <tbody>
                ...
                <div class="formC">
                  ...
                  $objetoC = new Clientes($conexion, 0, 'nombre', 'apellido', 'cedula', 'telefono', 'correo');
                  $listaC = $objetoC->listar(0);
                  while ($unRegistro = mysqli_fetch_array($listaC)) {
                    echo '<tr><form id="fModificarClientes"' . $unRegistro["idC"] . ' action="../controlador/ControladorC.php"
                 method="post">';
                    echo '<td><input type="hidden" name="fIdC"     value="' . $unRegistro['idC'] . '">';
                    echo '<input type="text"      name="fNombreC"   value="' . $unRegistro['nombreC'] . '"></td>';
                    echo '<td><input type="text"  name="fApellidoC"    value="' . $unRegistro['apellidoC'] . '"></td>';
                    echo '<td><input type="text"   name="fCedulaC"   value="' . $unRegistro['cedulaC'] . '"></td>';
                    echo '<td><input type="text"  name="fTelefonoC"    value="' . $unRegistro['telefonoC'] . '"></td>';
                    echo '<td><input type="email"   name="fCorreoC"   value="' . $unRegistro['correoC'] . '"></td>';
  ...
  <div><img src="imagen/frutitas.png" alt=""></div>

  <?php
  mysqli_free_result($listaC);
